<template>
  <div class="border-b border-sky-900 flex flex-row">
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
      width="24" height="24" viewBox="0 0 30 30" style="enable-background:new 0 0 30 30;" xml:space="preserve" class="fill-sky-900">
    ...
    <div class="mx-auto">
      <div class="flex flex-row justify-center text-center fill-sky-900 mt-4">
        <img 
          ...
          width="48"
          class="opacity-60"
          :src="getWindOne(props.windData.direction)" 
        ...
        <img 
          ...
          width="48"
          class="opacity-60"
          :src="getWindTwo(props.windData.direction)" 
          :alt="`${props.windData.direction}`" 
        />
      </div>
...
const getWindOne = (item) => {
  ...
  return new URL(`/assets/wind/${direction}.svg`, import.meta.url).href;
};
...
const validation = computed(() => {
  return !['North', 'South', 'East', 'West'].includes(props.windData.direction) && props.windData.direction.length > 2
})
</script>